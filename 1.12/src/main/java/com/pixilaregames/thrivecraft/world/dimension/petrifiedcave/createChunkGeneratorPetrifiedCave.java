...
public class createChunkGeneratorPetrifiedCave implements IChunkGenerator
{
    ...
    protected static final IBlockState OTHER_BLOCK1 = ModBlocks.ONYX_ORE.getDefaultState();
    ...
    */
    ...
    public createChunkGeneratorPetrifiedCave(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(ModBiome.PETRIFIEDCAVE_DIMENSION);
        }
