package com.pixilaremedia.thrivecraft.util.helpers;
...
public class BiomeDictionaryHelper
{
     ...
     * Based on {@link BiomeDictionary.Type#getType(String, BiomeDictionary.Type...)}, but doesn't greate a new {@link BiomeDictionary.Type} if the input is not already a {@link BiomeDictionary.Type}
     *
     ...
     *
     * @pram strings string array containing valid #BiomeDictionary.Types
