package com.pixilaremedia.thrivecraft.client.models;
...
public class BlackWidowModel //extends EntityModel<BlackWidow>
{
    ...
    @Override
    public void setRotationAngles(BlackWidow entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {}
