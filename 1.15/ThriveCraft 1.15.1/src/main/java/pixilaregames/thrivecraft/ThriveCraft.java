...
import pixilaregames.thrivecraft.Client.Renders.RnederRegistry;
import pixilaregames.thrivecraft.Config.Config;
...
public class ThriveCraft
{
	...
	public ThriveCraft()
	{
		...
		ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, Config.server_config, "thrivecraft-server.toml");
		ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, Config.client_config, "thrivecraft-client.toml");
		
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::setup);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientRegisteries);
		
		Config.loadConfig(Config.client_config, FMLPaths.CONFIGDIR.get().resolve("thrivecraft-client.toml").toString());
		Config.loadConfig(Config.server_config, FMLPaths.CONFIGDIR.get().resolve("thrivecraft-server.toml").toString());
	...
	public static class RegsitryEvents
	{
		...
		public static void registerItems(final Register<Item> event)
		{
			...
			(
					...
					//Armor
					ItemList.onyx_helmet = new ItemArmorBase(ArmorMaterialList.Onyx, EquipmentSlotType.HEAD, new Item.Properties().group(thrivecraft)).setRegistryName(location("onyx_helmet")),
					ItemList.onyx_chestplate = new ItemArmorBase(ArmorMaterialList.Onyx, EquipmentSlotType.CHEST, new Item.Properties().group(thrivecraft)).setRegistryName(location("onyx_chestplate")),
					ItemList.onyx_leggings = new ItemArmorBase(ArmorMaterialList.Onyx, EquipmentSlotType.LEGS, new Item.Properties().group(thrivecraft)).setRegistryName(location("onyx_leggings")),
					ItemList.onyx_boots = new ItemArmorBase(ArmorMaterialList.Onyx, EquipmentSlotType.FEET, new Item.Properties().group(thrivecraft)).setRegistryName(location("onyx_boots")),
					//Blocks
					ItemList.onyx_block = new BlockItem(BlockList.onyx_block, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.onyx_block.getRegistryName()),
					ItemList.onyx_ore = new BlockItem(BlockList.onyx_ore, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.onyx_ore.getRegistryName()),
					...
					//Blocks
					ItemList.stripped_petrified_log = new BlockItem(BlockList.stripped_petrified_log, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.stripped_petrified_log.getRegistryName()),
					ItemList.stripped_petrified_bark = new BlockItem(BlockList.stripped_petrified_bark, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.stripped_petrified_bark.getRegistryName()),
					ItemList.petrified_log = new BlockItem(BlockList.petrified_log, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_log.getRegistryName()),
					ItemList.petrified_bark = new BlockItem(BlockList.petrified_bark, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_bark.getRegistryName()),
					ItemList.petrified_planks = new BlockItem(BlockList.petrified_planks, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_planks.getRegistryName()),
					ItemList.petrified_sapling = new BlockItem(BlockList.petrified_sapling, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_sapling.getRegistryName()),
					ItemList.petrified_door = new BlockItem(BlockList.petrified_door, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_door.getRegistryName()),
					ItemList.petrified_slab = new BlockItem(BlockList.petrified_slab, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_slab.getRegistryName()),
					ItemList.petrified_stairs = new BlockItem(BlockList.petrified_stairs, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_stairs.getRegistryName()),
					ItemList.petrified_leaves = new BlockItem(BlockList.petrified_leaves, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_leaves.getRegistryName()),
					ItemList.petrified_fence = new BlockItem(BlockList.petrified_fence, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_fence.getRegistryName()),
					ItemList.petrified_fence_gate = new BlockItem(BlockList.petrified_fence_gate, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_fence_gate.getRegistryName()),
					ItemList.petrified_trapdoor = new BlockItem(BlockList.petrified_trapdoor, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_trapdoor.getRegistryName()),
					ItemList.petrified_pressure_plate = new BlockItem(BlockList.petrified_pressure_plate, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_pressure_plate.getRegistryName()),
					ItemList.petrified_button = new BlockItem(BlockList.petrified_button, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_button.getRegistryName()),
					ItemList.petrified_chest = new BlockItem(BlockList.petrified_chest, new Item.Properties().group(thrivecraft)).setRegistryName(BlockList.petrified_chest.getRegistryName())
			);
		...
		public static void registerBlockss(final Register<Block> event)
		{
			...
			(
					//Onyx Blocks
					BlockList.onyx_block = new Onyx_Block(Block.Properties.create(Material.IRON).hardnessAndResistance(5.0f, 6.0f).lightValue(0).sound(SoundType.METAL)).setRegistryName(location("onyx_block")),
					BlockList.onyx_ore = new Onyx_Ore(Block.Properties.create(Material.IRON).hardnessAndResistance(3.0f, 3.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("onyx_ore")),
					
					//Petrified Wood Blocks
					BlockList.stripped_petrified_log = new Stripped_Petrified_Log(MaterialColor.ADOBE, Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("stripped_petrified_log")),
					BlockList.stripped_petrified_bark = new Stripped_Petrified_Bark(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("stripped_petrified_bark")),
					BlockList.petrified_log = new Petrified_Log(MaterialColor.ADOBE, Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("petrified_log")),
					BlockList.petrified_bark = new Petrified_Bark(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("petrified_bark")),
					BlockList.petrified_planks = new Petrified_Planks(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("petrified_planks")),
					BlockList.petrified_sapling = new Petrified_Sapling(new Petrified_Tree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0f, 0.0f).sound(SoundType.PLANT)).setRegistryName(location("petrified_sapling")),
					BlockList.petrified_door = new Petrified_Door(Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).variableOpacity().sound(SoundType.WOOD)).setRegistryName(location("petrified_door")),
					BlockList.petrified_slab = new Petrified_Slab(Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).variableOpacity().sound(SoundType.WOOD)).setRegistryName(location("petrified_slab")),
					...
					BlockList.petrified_leaves = new Petrified_Leaves(Properties.create(Material.LEAVES).hardnessAndResistance(0.2f, 0.2f).tickRandomly().sound(SoundType.PLANT)).setRegistryName(location("petrified_leaves")),
					BlockList.petrified_fence = new Petrified_Fence(Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("petrified_fence")),
					BlockList.petrified_fence_gate = new Petrified_Fence_Gate(Properties.create(Material.WOOD).hardnessAndResistance(2.0f, 2.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("petrified_fence_gate")),
		...
		@SubscribeEvent
		public static void registerEntities(final Register<EntityType<?>> event)
		{
			event.getRegistry().registerAll
			(
