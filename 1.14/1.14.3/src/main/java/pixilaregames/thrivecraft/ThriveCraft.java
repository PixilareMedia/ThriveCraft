...
public class ThriveCraft
{
	...
	public ThriveCraft()
	{
		...
		ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, Config.server_config, "pixelcore-server.toml");
		ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, Config.client_config, "pixelcore-client.toml");
	...
	public static class RegsitryEvents
	{
		...
		public static void registerBlockss(final Register<Block> event)
		{
			...
			(
					...
					BlockList.stripped_petrified_log = new Stripped_Petrified_Log(MaterialColor.ADOBE, Block.Properties.create(Material.WOOD).hardnessAndResistance(0.0f, 10.0f).lightValue(0).sound(SoundType.WOOD)).setRegistryName(location("stripped_petrified_log")),
